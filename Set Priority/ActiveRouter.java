...
//      this.interactions = new ArrayList<String>();
    ...
    public boolean requestDeliverableMessages(Connection con)
    {
        ...
        Collections.sort(temp, new Sortbypreference());
        for (Message m : temp)
        {
            if (other == m.getTo())
            {
  ...
  * {@link Connection#startTransfer(DTNHost, Message)}
  ...
  /*  public boolean getWifi(Message m, DTNHost to){
     ...
     */
    public class SortListTuplebypreference implements Comparator< Tuple<Message,Connection> > 
    { 
        // Used for sorting in ascending order of 
        // roll name 
        public int compare(Tuple<Message,Connection> a, Tuple<Message,Connection> b) 
        { 
           return b.getKey().getPreference()-a.getKey().getPreference(); 
        } 
    } 
    protected Tuple<Message, Connection> tryMessagesForConnected(
        ...
        Collections.sort(tuples, new SortListTuplebypreference());
      ...
      */
    public class Sortlistbypreference implements Comparator<Message> 
    { 
        // Used for sorting in ascending order of 
        // roll name 
    ...
    protected Message tryAllMessages(Connection con, List<Message> messages) {
        Collections.sort(messages,new Sortlistbypreference());
        for (Message m : messages) {
    ...
    class Sortbypreference implements Comparator<Message> 
    { 
        // Used for sorting in ascending order of 
        // roll name 
        public int compare(Message a, Message b) 
    ...
    protected void shuffleMessages(List<Message> messages) {
        ...
        Collections.sort(messages, new Sortbypreference()); 
